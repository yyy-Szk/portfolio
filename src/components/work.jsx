        ...
        <div class="inner">
          ...
          <Grid container className="container">
            <Grid item xs={12} className="works image_box">
              ...
              <a href="https://github.com/Yoshimasa-Suzuki/gucchier">github</a> / <a href="https://polar-retreat-48576.herokuapp.com/">heroku</a>
            </Grid>
            <div class="desc">
              ...
              <p>　deviseを用いたtoken認証やフロントとバックを完全分離して開発することなど、使ってみたい技術を使う意識で開発したため、リファクタリングやテスト、デザインなどは甘くなっています。</p>
            </div>
          </Grid>
        </div>
        ...
        <div class="inner">
          ...
          <Grid contaier className="container" style={{textAlign: 'center'}}>
            ...
            <Grid item xs={12} className="works">
              ...
              <a href="https://github.com/Yoshimasa-Suzuki/hair-more">github</a> / <a href="https://mighty-journey-43203.herokuapp.com/">heroku</a>
            </Grid>
          </Grid>
        </div>
      </div>
